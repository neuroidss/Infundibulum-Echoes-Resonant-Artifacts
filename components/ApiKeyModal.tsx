  ...
  return (
    <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="w-full max-w-md bg-gray-900 border border-blue-800/50 rounded-lg p-8 shadow-2xl shadow-blue-500/10">
        <h2 className="text-2xl font-bold text-center text-blue-300 mb-2">AI Features Require Configuration</h2>
        <p className="text-center text-gray-400 mb-6 text-sm">
          To enable cloud-based AI models (like Gemini), please provide an API key.
          Local models can be configured in the settings panel.
        </p>
        ...
        <p className="text-center text-gray-500 mt-6 text-xs">
          ...
          <br />
          Manage all AI provider settings in the GUI panel.
        </p>
      </div>
    </div>
  );
